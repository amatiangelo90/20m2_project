...
class CustomerAccess {
  ...
  @JsonKey(name: 'customerAccessId')
  final num? customerAccessId;
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is CustomerAccess &&
            ...
            (identical(other.customerAccessId, customerAccessId) ||
                const DeepCollectionEquality()
                    .equals(other.customerAccessId, customerAccessId)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(customerAccessId) ^
  ...
  CustomerAccess copyWithWrapped(
    ...
    return CustomerAccess(
        ...
        branchLocation: (branchLocation != null
            ...
            : this.branchLocation),
        customerAccessId: (customerAccessId != null
            ? customerAccessId.value
            : this.customerAccessId),
