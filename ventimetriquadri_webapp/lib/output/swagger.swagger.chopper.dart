...
class _$Swagger extends Swagger {
  ...
  Future<Response<dynamic>> _apiV1AppBranchesDeleteDelete({
    ...
    final Map<String, dynamic> $params = <String, dynamic>{
      ...
      'events[0].workstations[0].workstationStatus':
  ...
  Future<Response<Event>> _apiV1AppEventSavePost({
    ...
    final Map<String, dynamic> $params = <String, dynamic>{
      ...
      'workstations[0].workstationStatus': workstations0WorkstationStatus,
  ...
  Future<Response<OrderEntity>> _apiV1AppOrderSendPost({
    ...
    final Map<String, dynamic> $params = <String, dynamic>{
      'products[0].orderProductId': products0OrderProductId,
      'products[0].productName': products0ProductName,
      'products[0].unitMeasure': products0UnitMeasure,
      'products[0].productId': products0ProductId,
      'products[0].price': products0Price,
      'products[0].amount': products0Amount,
      'orderId': orderId,
      'code': code,
      'total': total,
  ...
  @override
  Future<Response<dynamic>> _apiV1AppStorageDelete({
    required int? storageId,
    required int? productId,
  }) {
    final String $url = '/api/v1/app/storage';
    final Map<String, dynamic> $params = <String, dynamic>{
      'storageId': storageId,
      'productId': productId,
    };
  ...
  @override
  Future<Response<dynamic>> _apiV1AppStorageInsertproductGet({
    required int? storageId,
    required int? productId,
  }) {
  ...
  Future<Response<dynamic>> _apiV1AppUsersDeleteDelete({
    ...
    final Map<String, dynamic> $params = <String, dynamic>{
      ...
      'branchList[0].events[0].workstations[0].workstationStatus':
