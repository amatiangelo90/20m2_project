...
abstract class Swagger extends ChopperService {
  ...
  ///@param events[0].workstations[0].workstationStatus
  ...
  Future<chopper.Response> apiV1AppBranchesDeleteDelete({
    ...
    String? events0Workstations0WorkstationStatus,
    ...
    return _apiV1AppBranchesDeleteDelete(
        ...
        events0Workstations0WorkstationType:
            events0Workstations0WorkstationType,
        events0Workstations0WorkstationStatus:
            events0Workstations0WorkstationStatus,
  ...
  Future<chopper.Response> _apiV1AppBranchesDeleteDelete({
    ...
    @Query('events[0].workstations[0].workstationType')
        String? events0Workstations0WorkstationType,
    @Query('events[0].workstations[0].workstationStatus')
        String? events0Workstations0WorkstationStatus,
  ...
  ///@param workstations[0].workstationStatus
  ...
  Future<chopper.Response<Event>> apiV1AppEventSavePost({
    ...
    String? workstations0WorkstationStatus,
    ...
    return _apiV1AppEventSavePost(
        ...
        workstations0WorkstationStatus: workstations0WorkstationStatus,
  ...
  Future<chopper.Response<Event>> _apiV1AppEventSavePost({
    ...
    @Query('workstations[0].workstationType')
        String? workstations0WorkstationType,
    @Query('workstations[0].workstationStatus')
        String? workstations0WorkstationStatus,
  ...
  Future<chopper.Response<Workstation>>
    ...
    @Query('workstationStatus') String? workstationStatus,
    @Query('eventId') int? eventId,
  });
  ...
  ///sendOrder
  ///@param products[0].orderProductId
  ///@param products[0].productName
  ///@param products[0].unitMeasure
  ///@param products[0].productId
  ///@param products[0].price
  ///@param products[0].amount
  ///@param orderId
  ///@param code
  ///@param total
  ///@param orderStatus
  ...
  Future<chopper.Response<OrderEntity>> apiV1AppOrderSendPost({
    ...
    return _apiV1AppOrderSendPost(
        products0OrderProductId: products0OrderProductId,
        products0ProductName: products0ProductName,
        products0UnitMeasure: products0UnitMeasure,
        products0ProductId: products0ProductId,
        products0Price: products0Price,
        products0Amount: products0Amount,
        orderId: orderId,
        code: code,
        total: total,
  ...
  ///@param storageId
  @Post(
    path: '/api/v1/app/order/send',
    optionalBody: true,
  )
  Future<chopper.Response<OrderEntity>> _apiV1AppOrderSendPost({
    @Query('products[0].orderProductId') int? products0OrderProductId,
    @Query('products[0].productName') String? products0ProductName,
    @Query('products[0].unitMeasure') String? products0UnitMeasure,
    @Query('products[0].productId') int? products0ProductId,
    @Query('products[0].price') num? products0Price,
    @Query('products[0].amount') num? products0Amount,
    @Query('orderId') int? orderId,
    @Query('code') String? code,
    @Query('total') num? total,
    @Query('orderStatus') String? orderStatus,
    @Query('errorStatus') String? errorStatus,
    @Query('creationDate') String? creationDate,
    @Query('senderUser') String? senderUser,
    @Query('details') String? details,
    @Query('deliveryDate') String? deliveryDate,
    @Query('closedBy') String? closedBy,
  ...
  Future<chopper.Response> apiV1AppStorageDelete({
    required int? storageId,
    required int? productId,
  }) {
    return _apiV1AppStorageDelete(storageId: storageId, productId: productId);
  }

  ///deleteProductFromStorage
  ///@param storageId storageId
  ///@param productId productId
  @Delete(path: '/api/v1/app/storage')
  Future<chopper.Response> _apiV1AppStorageDelete({
  ...
  ///@param storageId storageId
  ///@param productId productId
  Future<chopper.Response> apiV1AppStorageInsertproductGet({
    required int? storageId,
    required int? productId,
  }) {
  ...
  Future<chopper.Response> _apiV1AppStorageInsertproductGet({
    @Query('storageId') required int? storageId,
    @Query('productId') required int? productId,
  });
  ...
  ///@param branchList[0].events[0].workstations[0].workstationStatus
  ...
  Future<chopper.Response> apiV1AppUsersDeleteDelete({
    ...
    String? branchList0Events0Workstations0WorkstationStatus,
    ...
    return _apiV1AppUsersDeleteDelete(
        ...
        branchList0Events0Workstations0WorkstationType:
            branchList0Events0Workstations0WorkstationType,
        branchList0Events0Workstations0WorkstationStatus:
            branchList0Events0Workstations0WorkstationStatus,
  ...
  Future<chopper.Response> _apiV1AppUsersDeleteDelete({
    ...
    @Query('branchList[0].events[0].workstations[0].workstationType')
        String? branchList0Events0Workstations0WorkstationType,
    @Query('branchList[0].events[0].workstations[0].workstationStatus')
        String? branchList0Events0Workstations0WorkstationStatus,
