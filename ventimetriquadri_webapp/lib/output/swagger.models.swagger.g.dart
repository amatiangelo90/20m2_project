...
ROrderProduct _$ROrderProductFromJson(Map<String, dynamic> json) =>
    ROrderProduct(
      ...
      unitMeasure: rOrderProductUnitMeasureFromJson(json['unitMeasure']),
    );
...
Map<String, dynamic> _$ROrderProductToJson(ROrderProduct instance) =>
    <String, dynamic>{
      ...
      'unitMeasure': rOrderProductUnitMeasureToJson(instance.unitMeasure),
    };
...
RWorkstationProduct _$RWorkstationProductFromJson(Map<String, dynamic> json) =>
    RWorkstationProduct(
      ...
      unitMeasure: rWorkstationProductUnitMeasureFromJson(json['unitMeasure']),
...
Map<String, dynamic> _$RWorkstationProductToJson(
    ...
    <String, dynamic>{
      ...
      'unitMeasure': rWorkstationProductUnitMeasureToJson(instance.unitMeasure),
...
RStorageProduct _$RStorageProductFromJson(Map<String, dynamic> json) =>
    RStorageProduct(
      ...
      unitMeasure: rStorageProductUnitMeasureFromJson(json['unitMeasure']),
    );
...
Map<String, dynamic> _$RStorageProductToJson(RStorageProduct instance) =>
    <String, dynamic>{
      ...
      'unitMeasure': rStorageProductUnitMeasureToJson(instance.unitMeasure),
    };
...
Workstation _$WorkstationFromJson(Map<String, dynamic> json) => Workstation(
      ...
      workstationStatus:
          workstationWorkstationStatusFromJson(json['workstationStatus']),
      workstationType:
...
Map<String, dynamic> _$WorkstationToJson(Workstation instance) =>
    <String, dynamic>{
      ...
      'workstationStatus':
          workstationWorkstationStatusToJson(instance.workstationStatus),
      'workstationType':
